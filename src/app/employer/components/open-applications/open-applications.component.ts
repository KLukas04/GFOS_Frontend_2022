...
export class OpenApplicationsComponent implements OnInit {
  ...
  show(actions: PolymorpheusContent<TuiPdfViewerOptions>, titel: string) {
    this.pdfService
      .open(
        this.sanitizer.bypassSecurityTrustResourceUrl(this.prefix + this.pdfInBase64),
        {
          label: titel,
          actions,
        },
